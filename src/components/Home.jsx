        ...
        <>
            ...
            >
                <div className="row">
                    ...
                    <div className="col-6" style={{ padding: "190px 150px 110px 150px" }}>
                        <div className="LogIn-form" style={{ border: "1px solid black", padding: "50px 50px 90px 50px", borderRadius: "12px" }}>
                            <h3>ADMIN LOGIN FORM</h3>
                            <br />
                            <label htmlFor=""> Name</label>
                            <br />
                            <input type="text" name='name' onChange={handleAdminLoginData} placeholder='enter Name' autocomplete="off" /><br />
                            <br />
